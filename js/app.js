...
class SwissFinanceApp {
    ...
    async init() {
        ...
        // Set profile selects
        document.getElementById('desktop-profile-select').value = this.state.data.currentProfile;
        document.getElementById('mobile-profile-select').value = this.state.data.currentProfile;
